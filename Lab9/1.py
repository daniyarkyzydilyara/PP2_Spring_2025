...
#bg image
background = pygame.image.load("C:/Users/user/Desktop/pp2/TSIS9/images/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/user/Desktop/pp2/TSIS9/images/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/user/Desktop/pp2/TSIS9/images/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy,size):
        super().__init__()
        if size == "small":
            self.image = pygame.image.load("C:/Users/user/Desktop/pp2\TSIS9/images/small_coin.png")
        elif size == "medium":
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("C:/Users/user/Desktop/pp2/TSIS9/images/crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("C:/Users/user/Desktop/pp2/TSIS9/images/getcoin.mp3").play()
